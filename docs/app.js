...
12. VOICE: write "why_it_fits" in second person, speaking directly to the reader ("you mentioned...", "since you loved...", "you'll recognise...") — never third person ("the reader...", "they...", "this reader's..."). This is a voice/phrasing rule only — it does not change what rule 6 requires you to cite, only how you address the reader while citing it. Applies regardless of which mode produced the pick (normal, SURPRISE MODE, or a rule-11 cluster pick). "description" and "resolution" are unaffected — write those as before.
